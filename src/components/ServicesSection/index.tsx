    ...
    <>
      <section className="pt-8 container mx-auto flex flex-wrap justify-between mt-44">
        <div className="w-full">
          <div className="grid lg:grid-cols-4 xl:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-6">
            <div className="w-full">
              <Image src={Group1} alt="" className="w-32 h-32 rounded-2xl" />
              <h1 className="text-2xl font-bold mt-2">
                Simplify complex data with
                <br />
                our expert database design
                <br />
                services
              </h1>
              <p className="mt-2 text-xl">
                ...
                Lorem netus lacinia convallis.
              </p>
            </div>
            <div className="w-full">
              <Image src={Group92} alt="" className="w-32 h-32 rounded-2xl" />
              ...
              <p className="mt-3 text-xl">
                ...
                <br /> Lorem netus lacinia convallis.
              </p>
            </div>
            <div className="w-full">
              <Image src={Archieve} alt="" className="w-32 h-32 rounded-2xl" />
            ...
            <div className="w-full lg:mt-10 xl:mt-10">
              <Image src={Archieve} alt="" className="w-32 h-32 rounded-2xl" />
